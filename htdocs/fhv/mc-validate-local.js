...
!function(a) {
    ...
    a.extend(a.validator, {
        ...
        messages: {
            ...
            email: "Por favor, introduce un correo electrónico válida.",
            url: "Por favor introduzca un URL válida.",
            date: "Por favor introduzca una fecha valida.",
            dateISO: "Por favor introduzca una fecha valida en formato ISO.",
    ...
    window.mc = {
        ...
        mce_success_cb: function(resp) {
            ...
            if (resp.result == "success") {
                var poner1 = getAbsolutePath();
                $('#mce-' + resp.result + '-response').show();
               // $('#mce-' + resp.result + '-response').html(resp.msg);
                $('#mce-' + resp.result + '-response').html("Fue registrado con éxito");
                //var ponerfinal = poner1.replace(/\/[A-Za-z0-9_\s]+$/, '/gracias' );
                var ponerfinal = poner1 + 'gracias' ;
                $('#mc-embedded-subscribe-form').each(function() {
                    this.reset();
                });
                window.location.href = ponerfinal;
                ...
                try {
                    ...
                    if (parts[1] == undefined) {
                        ...
                        if( resp.msg == 'Recipient "manjou132@gmail.com" has too many recent signup requests'){
                            ...
                            msg = `El destinatario ${correo[1]} tiene demasiadas solicitudes de registro recientes`;
                        } else if(expre2.test(resp.msg)) {
                        ...
                        if (i.toString() == parts[0]) {
                            ...
                            if( resp.msg === 'Recipient "manjou132@gmail.com" has too many recent signup requests'){
                                ...
                                msg = `El destinatario "${m[0]}" tiene demasiadas solicitudes de registro recientes`;
                            }
                            //msg = resp.msg;
                        }
                    }
